export const contactContent = {
  en: {
    ...
    getSection: {
      ...
      items: [
        ...
        },
        {
          ...
          text: "We explain the application procedure, the stages involved, document requirements and review timelines.",
        },
        {
          title: "Professional recommendations",
          text: "By the end of the consultation, you will have an objective understanding of the available options and the ability to make an informed decision.",
        },
      ],
    },
    format: {
      title: "How the Consultation Takes Place",
      text: "We offer a convenient format based on your location and preference. The consultation may take place online, by phone, or in person where available. Its length is determined individually and depends on the complexity of your request.",
    },
    details: {
    ...
    form: {
      ...
      text: "Fill in the form below and we will get back to you shortly to discuss your request and identify the most suitable solution.",
    },
    closing: {

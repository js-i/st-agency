...
export const homeContent = {
  en: {
    ...
    strategy: {
      ...
      paragraphs: [
        ...
        "Every situation is unique. That is why we begin not with choosing a programme, but with understanding your goals.",
      ],
    },
    whyUs: {
      title: "Why clients choose Island Horizons",
      items: [
        {
          icon: ShieldIcon,
          title: "Individual Approach",
          text: "We study every client's goals closely and match them to a programme that fits their personal, family and professional priorities.",
        },
        {
          icon: HandshakeIcon,
        ...
        {
          icon: DocumentsIcon,
          title: "Official Government Programmes",
          text: "We work exclusively with government citizenship-by-investment programmes, in full compliance with the law and established procedures.",
        },
        {
          icon: PrivacyIcon,
        ...
        },
        {
          icon: GlobeIcon,
          title: "Transparency",
          text: "We explain the procedure, programme requirements, review timelines and official costs in advance — clearly and in full.",
        },
        {
          icon: CompassIcon,
          title: "International Expertise",
          text: "We closely follow the evolution of investment migration programmes and help clients navigate changing international requirements.",
        },
      ],
    },
    solutions: {
      title: "Our Solutions",
      text: "We guide clients through selecting and obtaining citizenship under government investment programmes. Each programme has its own features, requirements and advantages — our task is to help you choose the solution that best fits your long-term goals.",
      availableLabel: "Available Programme",
      availableName: "São Tomé and Príncipe",
      availableText:
        "A modern government programme designed to attract international investment and support the country's sustainable development.",
      upcomingLabel: "Expanding Soon",
      upcomingText:
        "The Island Horizons portfolio will continue to grow to include further international citizenship-by-investment programmes.",
      cta: "More About Our Programmes",
    },
    approach: {
      title: "Our Approach",
      text: "We see obtaining second citizenship not as a standalone procedure but as part of long-term planning. That is why our work always begins with a consultation. We study your goals carefully, analyse the available options, and recommend a programme that genuinely fits your interests. Once a programme is selected, we organise the entire process and guide you through to completion — every stage handled sequentially, transparently, and under the continuous oversight of our specialists.",
      cta: "How We Work",
    },
    trust: {
      ...
      points: [
        ...
        "work exclusively with official government programmes",
    ...
    finalCta: {
      ...
      text: "Every situation is individual. During the first consultation, we will get to know your goals, walk you through the current programmes, answer your questions, and help identify the most suitable solution. We look forward to accompanying you toward new international opportunities.",
  ...
  ru: {
    ...
    whyUs: {
      title: "Почему выбирают Island Horizons",
      items: [
        {
          icon: ShieldIcon,
    ...
    solutions: {
      ...
      availableText:
        "Современная государственная программа, направленная на привлечение международных инвестиций и устойчивое развитие страны.",
      upcomingLabel: "Портфель расширяется",
      upcomingText:
        "Портфель программ Island Horizons будет расширяться. В него войдут и другие международные программы получения гражданства за инвестиции.",
